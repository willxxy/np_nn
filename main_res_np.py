...
from resnet_np import ResNet, numpy_eval, layer_init
...
if __name__ == '__main__':
    ...
    for i in tqdm(range(4000), desc = 'Training Numpy MLP'):
        ...
        Y = Y_train[sample]
        x_loss, x_layer2, d_layer1, d_layer2 = ResNet(X, Y, layer1, layer2)
    ...
    plt.savefig('./learning_curves/loss_plot_resnet_np.png')
    plt.close()
    ...
    plt.savefig('./learning_curves/accuracy_plot_resnet_np.png')
    plt.close()
